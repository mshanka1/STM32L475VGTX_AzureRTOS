...
C_SRCS += \
../Core/wifi_driver/nx_driver_stm32l4.c 

OBJS += \
./Core/wifi_driver/nx_driver_stm32l4.o 

C_DEPS += \
./Core/wifi_driver/nx_driver_stm32l4.d 


# Each subdirectory must supply rules for building sources it contributes
Core/wifi_driver/%.o Core/wifi_driver/%.su Core/wifi_driver/%.cyclo: ../Core/wifi_driver/%.c Core/wifi_driver/subdir.mk
...
clean: clean-Core-2f-wifi_driver

clean-Core-2f-wifi_driver:
	-$(RM) ./Core/wifi_driver/nx_driver_stm32l4.cyclo ./Core/wifi_driver/nx_driver_stm32l4.d ./Core/wifi_driver/nx_driver_stm32l4.o ./Core/wifi_driver/nx_driver_stm32l4.su

.PHONY: clean-Core-2f-wifi_driver
