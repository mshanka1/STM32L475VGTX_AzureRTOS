...
C_SRCS += \
../Core/wifi_driver/addons/http/nxd_http_client.c \
../Core/wifi_driver/addons/http/nxd_http_server.c 

OBJS += \
./Core/wifi_driver/addons/http/nxd_http_client.o \
./Core/wifi_driver/addons/http/nxd_http_server.o 

C_DEPS += \
./Core/wifi_driver/addons/http/nxd_http_client.d \
./Core/wifi_driver/addons/http/nxd_http_server.d 


# Each subdirectory must supply rules for building sources it contributes
Core/wifi_driver/addons/http/%.o Core/wifi_driver/addons/http/%.su Core/wifi_driver/addons/http/%.cyclo: ../Core/wifi_driver/addons/http/%.c Core/wifi_driver/addons/http/subdir.mk
...
clean: clean-Core-2f-wifi_driver-2f-addons-2f-http

clean-Core-2f-wifi_driver-2f-addons-2f-http:
	-$(RM) ./Core/wifi_driver/addons/http/nxd_http_client.cyclo ./Core/wifi_driver/addons/http/nxd_http_client.d ./Core/wifi_driver/addons/http/nxd_http_client.o ./Core/wifi_driver/addons/http/nxd_http_client.su ./Core/wifi_driver/addons/http/nxd_http_server.cyclo ./Core/wifi_driver/addons/http/nxd_http_server.d ./Core/wifi_driver/addons/http/nxd_http_server.o ./Core/wifi_driver/addons/http/nxd_http_server.su

.PHONY: clean-Core-2f-wifi_driver-2f-addons-2f-http
